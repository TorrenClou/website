...
## Step 2: Configure in TorrenClou
...
TorrenClou uses **resumable multipart uploads** for large files. If an upload is interrupted (e.g., container restart), it will resume from where it left off.
